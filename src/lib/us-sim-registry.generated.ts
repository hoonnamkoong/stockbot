...
export const US_SIM_REGISTRY: USSimRegistryEntry[] = [
  ...
  { id: 'us_sim3_liquidity', uiKey: 'us_sim3', label: 'US 기준선·유동성 상위 (US Sim 3)', shortDesc: '거래대금 상위 5종목 20거래일 리밸런스 · 신호 없는 잣대', color: 'gray', chartGroup: 1, stateFile: 'sim_us3liquidity_state.json', csvFile: 'trade_history_sim_us3liquidity.csv', tradeable: false, currency: 'USD' },
];