...
export async function GET(request: Request) {
    ...
    try {
            ...
            const forceRun = searchParams.get('force_run') === 'true';
            ...
            if (forceRun) {
                            console.log(`[Cron] FORCE_RUN=true detected. Bypassing market check.`);
            }
            ...
            try {
                            const response = await axios.post(
                                ...
                                { 
                                                    ref: 'main',
                                                        inputs: {
                                                                                    force_run: forceRun.toString() // [Important] GitHub API inputs often require strings
                                                        }
                                },
                                {
                                                        headers: {
