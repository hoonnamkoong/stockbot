...
| `2815f63f` `4c12eee3` | 6순위 둘째 조각 — 심 카드 분리(1,040 → 831줄) |

지금 상태: pytest 463 · node 92 · push마다 CI 자동 실행.
...
### 6순위 — `TradeClient.tsx` 분해 (1,040 → 831줄) ← **두 조각 완료, 여기서 이어간다**
