...
# investor_flows.csv는 연구·백테스트용 누적 아카이브라 늦더라도 채우는 편이 빈 것보다
# 낫다(TR이 최근 30거래일만 준다 — 오늘 안 받으면 오늘 것은 영원히 못 받는다).
# 장중에 이 파일을 읽는 코드는 없다 — 심12·13이 쓰는 수급은 trade_engine이 KIS에서
# 직접 받는다(2026-09-14 확인).
